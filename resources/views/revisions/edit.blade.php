...
<div id="main">
    <div class="container mt-5">
        ...
        <div class="row p-3">
        <div class="col-md-12">
            <a href="{{route('revisions.review',$post)}}" role="button" class="btn btn-dark">Back</a>
        </div>
        </div>
    </div>
        ...
        <div class="container mt-1 mb-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @if(!old('cuisine') && in_array($cuisine->id,$cuisine_ids))
                    checked
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="container">
            <div class="row p-3">
                <div class="col-sm-2">
                    <input type="submit" name="action" class="btn btn-outline-success" value="Approve & Publish" />
                </div>
            </div>
            @error('action')
            <div class="row">
